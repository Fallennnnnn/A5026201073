...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Ega Fernanda Putra</title>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <div class="title m-b-md">
                    Ega Fernanda Putra <br>
                    5026201073
                </div>

                <div class="links">
                    <a href="profilega.html">Tugas 1</a>
                    <a href="egaprofilcss.html">Tugas 2</a>
                    <a href="flexbootstrapega.html">Tugas 3</a>
